...
import { routesJournal } from "./modules/journal/routes.js";
import { routesVentesRapides } from "./modules/ventes-rapides/routes.js";
import { routesExports } from "./modules/exports/routes.js";
import { routesAdminContenu } from "./modules/admin/contenu-routes.js";
import { routesEspace } from "./modules/espace/routes.js";
import { routesSupport } from "./modules/support/routes.js";
import { routesInventaire } from "./modules/inventaire/routes.js";
import { routesContrats } from "./modules/contrats/routes.js";
import { routesDemandes } from "./modules/demandes/routes.js";
...
await app.register(routesVentesRapides);
await app.register(routesExports);
await app.register(routesAdminContenu);
await app.register(routesEspace);
await app.register(routesSupport);
await app.register(routesInventaire);
await app.register(routesContrats);
await app.register(routesDemandes);
